    ...
    public class MFAPackageData : PackageData
    {
        ...
        public override void Read(ByteReader reader)
        {
            ...
            AppHeader.GraphicMode = (short)reader.ReadInt();
            {
                ...
                if (cnt >= 3)
                {
                    FRipCore.CurrentReader.Icons.Add(64, IconBank.Images[reader.ReadUInt()].GetBitmap());
                    FRipCore.CurrentReader.Icons.Add(32, IconBank.Images[reader.ReadUInt()].GetBitmap());
                    FRipCore.CurrentReader.Icons.Add(16, IconBank.Images[reader.ReadUInt()].GetBitmap());
                }
                reader.Seek(end);
            }
