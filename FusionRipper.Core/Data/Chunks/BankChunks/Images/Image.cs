...
namespace FusionRipper.Core.Data.Chunks.BankChunks.Images
{
    public class Image : Chunk
    {
        ...
        public static Image NewImage()
        {
            if (FRipCore.MFA)
                return new ImageMFA();
            else if (FRipCore.CurrentReader is OpenFileReader)
                return new ImageOpen();
            else if (FRipCore.Android || FRipCore.iOS)
                return new ImageMobile();
            else if (FRipCore.Flash)
                return new ImageFlash();
            else if (FRipCore.PackageData.ExtendedHeader.CompressionFlags["OptimizeImageSize"])
                ...
                switch (GraphicMode)
                {
                    ...
                    case 4:
                        if (FRipCore.Android)
                            ...
                            colorArray = ImageTranslator.Normal24BitMaskedToRGBA(ImageData, Width, Height, Flags["Alpha"], TransparentColor, Flags["RLE"] || Flags["RLEW"] || Flags["RLET"], FRipCore.Fusion == 3f);
                        break;
                    case 5:
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        colorArray = ImageTranslator.TwoFivePlusToRGBA(ImageData, Width, Height, Flags["Alpha"], TransparentColor, Flags["RGBA"], FRipCore.Fusion == 3f);
                        break;
                    case 9:
        ...
        public void PrepareForMfa()
        {
            switch (GraphicMode)
            {
                ...
                case 5:
                    ...
                    break;
                case 8:
                    ImageData = ImageTranslator.TwoFivePlusToRGBA(ImageData, Width, Height, Flags["Alpha"], TransparentColor, Flags["RGBA"], FRipCore.Fusion > 2.5f);
