...
using FusionRipper.Core.Data.Chunks.MFAChunks.MFAObjectChunks;
...
using FusionRipper.Core.Data.Chunks.FrameChunks.Events;
    ...
    public class Frame : Chunk
    {
        ...
        public override void ReadCCN(ByteReader reader, params object[] extraInfo)
        {
            ...
            if (FrameHeader.FrameFlags["DontInclude"])
                ...
                FRipCore.PackageData.Frames.Add(this);
        ...
        public override void WriteMFA(ByteWriter writer, params object[] extraInfo)
        {
            ...
            foreach (FrameInstance instance in FrameInstances.Instances)
                if (!objectInfos.ContainsKey(instance.ObjectInfo))
                {
                    ...
                    ObjectInfo oI = FRipCore.PackageData.FrameItems.Items[(int)instance.ObjectInfo];
                    ...
                    if (newOI.InkEffect != 1)
                    {
                        ...
                        {
                            newOI.ObjectEffects.Shader = FRipCore.PackageData.ShaderBank.Shaders[oI.Shader.ShaderHandle];
                        ...
                        default:
                            ...
                            switch (oI.Header.Type)
                            {
                                ...
                                default:
                                    ...
                                    Extension ext = FRipCore.PackageData.Extensions.Exts[newOI.ObjectType - 32];
