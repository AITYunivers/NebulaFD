...
using Action = FusionRipper.Core.Data.Chunks.FrameChunks.Events.Action;
using Color = System.Drawing.Color;

namespace FusionRipper.Plugins.EncKeyDumper
{
    public class KeyDumper : IFRipPlugin
    {
        ...
        {
            PackageData data = FRipCore.PackageData;
